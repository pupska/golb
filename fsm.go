...
func (fsm *fsm) Snapshot() (raft.FSMSnapshot, error) {
	...
	return &fsmSnapshot{stateValue: fsm.stateValue, webLeaderAddr: fsm.webLeaderAddr}, nil
}
...
func (fsm *fsm) Restore(serialized io.ReadCloser) error {
	...
	fsm.webLeaderAddr = snapshot.webLeaderAddr
	return nil
}
